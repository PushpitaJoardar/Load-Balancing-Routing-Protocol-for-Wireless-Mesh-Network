...
struct RreqHeaderTest : public TestCase
{
  ...
  virtual void DoRun ()
  {
    RreqHeader h (/*flags*/ 0, /*reserved*/ 0,0, /*hopCount*/ 6, /*requestID*/ 1, /*dst*/ Ipv4Address ("1.2.3.4"),
    ...
    NS_TEST_EXPECT_MSG_EQ (h.GetForwardBufferCount (), 0, "trivial");
...
struct RrepHeaderTest : public TestCase
{
  ...
  virtual void DoRun ()
  {
    RrepHeader h (/*prefixSize*/ 0,0,/*hopCount*/ 12, /*dst*/ Ipv4Address ("1.2.3.4"), /*dstSeqNo*/ 2,
                                 /*origin*/ Ipv4Address ("4.3.2.1"), /*lifetime*/ Seconds (3));
    NS_TEST_EXPECT_MSG_EQ (h.GetPrefixSize (), 0, "trivial");
    NS_TEST_EXPECT_MSG_EQ (h.GetBackwardBufferCount (), 0, "trivial");
