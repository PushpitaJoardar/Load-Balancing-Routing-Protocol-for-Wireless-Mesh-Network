...
public:
   ...
   * \param forward_buffer size of the forward buffer
   ...
   */
   RreqHeader (uint8_t flags = 0, uint8_t reserved = 0, uint32_t forward_buffer = 0, uint8_t hopCount = 0,
   ...
   */
  void SetForwardBufferCount (uint32_t count)
  {
    m_forward_buffer = count;
  }
  /**
   * \brief Get the forwardbuffercount
   * \return forwardbuffercount
   */
  uint32_t GetForwardBufferCount () const
  {
    return m_forward_buffer;
  }
...
public:
   ...
   */
  RrepHeader (uint8_t prefixSize = 0,uint32_t m_back_buffer = 0, uint8_t hopCount = 0, 
              Ipv4Address dst = Ipv4Address (), uint32_t dstSeqNo = 0, Ipv4Address origin =
   ...
   * \param count the hop count
   */
  void SetbackwardBufferCount (uint32_t count)
  {
    m_back_buffer = count;
  }
  /**
   ...
   * \return the hop count
   */
  uint8_t GetBackwardBufferCount () const
  {
