...
// RREQ
//-----------------------------------------------------------------------------
RreqHeader::RreqHeader (uint8_t flags, uint8_t reserved,uint32_t forward_buffer,uint8_t hopCount, uint32_t requestID, Ipv4Address dst,
                        uint32_t dstSeqNo, Ipv4Address origin, uint32_t originSeqNo)
  : m_flags (flags),
    m_reserved (reserved),
    m_forward_buffer(forward_buffer),
    m_hopCount (hopCount),
...
RreqHeader::operator== (RreqHeader const & o) const
{
  return (m_flags == o.m_flags && m_reserved == o.m_reserved
          && m_forward_buffer == o.m_forward_buffer && m_hopCount == o.m_hopCount && m_requestID == o.m_requestID
...
RrepHeader::RrepHeader (uint8_t prefixSize, uint32_t back_buffer,uint8_t hopCount, Ipv4Address dst,
...
{
  return (m_flags == o.m_flags && m_prefixSize == o.m_prefixSize && m_back_buffer == o.m_back_buffer
